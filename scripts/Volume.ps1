...
function New-DSCCVolumeDeviceType2
{
<#
.SYNOPSIS
    Creates a new Volume on the specified Device-Type2 Storage System.    
.DESCRIPTION
    Creates a new Volume on the Specified Storage System with the supplied parameters. The Storage System must be of Device-Type2.  
.PARAMETER StorageID
    A single Storage System ID is specified and required. 
.PARAMETER name
    A single name is specified and required, and is required.
...
.PARAMETER base_snap_id
    ...
    digit hexadecimal int64. Defaults to the empty string. 
...
param(  [Parameter(Mandatory)]      [string]    $SystemId, 
        ...
        [ValidateSet(4096,8192,16384,32768,65536)]  
                                    ...
                                    [string]    $description,
                                    [string]    $dest_pool_id,
        [ValidateSet('none','aes_256_xts')]
                                    [string]    $encryption_cipher,
                                    [string]    $folder_id,
        [ValidateRange(0,100)]      [int]       $limit,
        [ValidateRange(256,4294967294)]
                                    [int]       $limit_iops,
        [ValidateRange(256,4294967294)]
                                    [int]       $limit_mbps,
                                    [switch]    $multi_initiator,
                                    [switch]    $online,
...
function New-DSCCVolumeDeviceType1
{
<#
.SYNOPSIS
    Creates a new Volume on the specified DeviceType1 Storage System.    
.DESCRIPTION
    Creates a new Volume on the Specified Storage System with the supplied parameters. This command only works on Device-Type1 storage systems.
.PARAMETER StorageID
...
.PARAMETER count
    How many Volumes to create using the given parameters. 
.PARAMETER dataReduction
    If data reduction technologies such as compression or deduplication should be turned on. 
.PARAMETER snapCpg
...
.PARAMETER WhatIf
    ...
    This option is very helpful when trying to understand the inner workings of the native RestAPI calls that DSCC uses.
.EXAMPLE
Creating a Device-Type1 type Volume on a Alletra9K or Primera device.
...
param(  [Parameter(Mandatory)]  [string]    $SystemId, 
        ...
        [Parameter(Mandatory)]  [string]    $userCpg,
                                [string]    $comments,
                                [int]       $count,
...
function Set-DSCCVolumeDeviceType1
{
<#
.SYNOPSIS
    Modifies a Volume on the specified Device-Type1 Storage System.    
.DESCRIPTION
    Modifies a Volume on the Specified Storage System with the supplied parameters. The storage System ID must be a device-type1. 
.PARAMETER StorageSystemId
    A single Storage System ID is specified and required.
.PARAMETER Id
...
param(  [Parameter(Mandatory)]      [string]    $SystemId, 
        ...
        [ValidateSet('CONVERSIONTYPE_THIN','CONVERSIONTYPE_DDS')]
...
function Set-DSCCVolumeDeviceType2
{
<#
.SYNOPSIS
    Modifies a Volume on the specified Device-Type2 Storage System.    
.DESCRIPTION
    Modifies a Volume on the Specified Device-Type 2 Storage System with the supplied parameters. 
.PARAMETER StorageSystemId
    A single Storage System ID is specified and required.
.PARAMETER Id
    A single Volume ID is specified and required.
...
.PARAMETER caching_enabled
    Indicate whether caching is enabled. Defaults to 'false'. 
.PARAMETER folder_id
    ID of the folder holding this volume. An optional NsObjectID. A 42 digit hexadecimal int64 or the empty string. 
    Defaults to the empty string. 
.PARAMETER limit
